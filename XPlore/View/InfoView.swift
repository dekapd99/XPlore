...
struct AppInfoView: View {
    var body: some View {
        VStack(alignment: .leading, spacing: 10) {
            RowAppInfoView(itemOne: "Application", itemTwo: "XPlore")
            RowAppInfoView(itemOne: "Compability", itemTwo: "iPhone and iPad")
            RowAppInfoView(itemOne: "Developer", itemTwo: "Deka Primatio Deandra")
            RowAppInfoView(itemOne: "Github", itemTwo: "https://github.com/dekapd99")
